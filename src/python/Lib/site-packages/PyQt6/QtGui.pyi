...
class QGradient(PyQt6.sip.simplewrapper):
    ...
    class config(enum.Enum):
        WarmFlame = ... # type: QGradient.config
        NightFade = ... # type: QGradient.config
        SpringWarmth = ... # type: QGradient.config
        JuicyPeach = ... # type: QGradient.config
        YoungPassion = ... # type: QGradient.config
        LadyLips = ... # type: QGradient.config
        SunnyMorning = ... # type: QGradient.config
        RainyAshville = ... # type: QGradient.config
        FrozenDreams = ... # type: QGradient.config
        WinterNeva = ... # type: QGradient.config
        DustyGrass = ... # type: QGradient.config
        TemptingAzure = ... # type: QGradient.config
        HeavyRain = ... # type: QGradient.config
        AmyCrisp = ... # type: QGradient.config
        MeanFruit = ... # type: QGradient.config
        DeepBlue = ... # type: QGradient.config
        RipeMalinka = ... # type: QGradient.config
        CloudyKnoxville = ... # type: QGradient.config
        MalibuBeach = ... # type: QGradient.config
        NewLife = ... # type: QGradient.config
        TrueSunset = ... # type: QGradient.config
        MorpheusDen = ... # type: QGradient.config
        RareWind = ... # type: QGradient.config
        NearMoon = ... # type: QGradient.config
        WildApple = ... # type: QGradient.config
        SaintPetersburg = ... # type: QGradient.config
        PlumPlate = ... # type: QGradient.config
        EverlastingSky = ... # type: QGradient.config
        HappyFisher = ... # type: QGradient.config
        Blessing = ... # type: QGradient.config
        SharpeyeEagle = ... # type: QGradient.config
        LadogaBottom = ... # type: QGradient.config
        LemonGate = ... # type: QGradient.config
        ItmeoBranding = ... # type: QGradient.config
        ZeusMiracle = ... # type: QGradient.config
        OldHat = ... # type: QGradient.config
        StarWine = ... # type: QGradient.config
        HappyAcid = ... # type: QGradient.config
        AwesomePine = ... # type: QGradient.config
        NewYork = ... # type: QGradient.config
        ShyRainbow = ... # type: QGradient.config
        MixedHopes = ... # type: QGradient.config
        FlyHigh = ... # type: QGradient.config
        StrongBliss = ... # type: QGradient.config
        FreshMilk = ... # type: QGradient.config
        SnowAgain = ... # type: QGradient.config
        FebruaryInk = ... # type: QGradient.config
        KindSteel = ... # type: QGradient.config
        SoftGrass = ... # type: QGradient.config
        GrownEarly = ... # type: QGradient.config
        SharpBlues = ... # type: QGradient.config
        ShadyWater = ... # type: QGradient.config
        DirtyBeauty = ... # type: QGradient.config
        GreatWhale = ... # type: QGradient.config
        TeenNotebook = ... # type: QGradient.config
        PoliteRumors = ... # type: QGradient.config
        SweetPeriod = ... # type: QGradient.config
        WideMatrix = ... # type: QGradient.config
        SoftCherish = ... # type: QGradient.config
        RedSalvation = ... # type: QGradient.config
        BurningSpring = ... # type: QGradient.config
        NightParty = ... # type: QGradient.config
        SkyGlider = ... # type: QGradient.config
        HeavenPeach = ... # type: QGradient.config
        PurpleDivision = ... # type: QGradient.config
        AquaSplash = ... # type: QGradient.config
        SpikyNaga = ... # type: QGradient.config
        LoveKiss = ... # type: QGradient.config
        CleanMirror = ... # type: QGradient.config
        PremiumDark = ... # type: QGradient.config
        ColdEvening = ... # type: QGradient.config
        CochitiLake = ... # type: QGradient.config
        SummerGames = ... # type: QGradient.config
        PassionateBed = ... # type: QGradient.config
        MountainRock = ... # type: QGradient.config
        DesertHump = ... # type: QGradient.config
        JungleDay = ... # type: QGradient.config
        PhoenixStart = ... # type: QGradient.config
        OctoberSilence = ... # type: QGradient.config
        FarawayRiver = ... # type: QGradient.config
        AlchemistLab = ... # type: QGradient.config
        OverSun = ... # type: QGradient.config
        PremiumWhite = ... # type: QGradient.config
        MarsParty = ... # type: QGradient.config
        EternalConstance = ... # type: QGradient.config
        JapanBlush = ... # type: QGradient.config
        SmilingRain = ... # type: QGradient.config
        CloudyApple = ... # type: QGradient.config
        BigMango = ... # type: QGradient.config
        HealthyWater = ... # type: QGradient.config
        AmourAmour = ... # type: QGradient.config
        RiskyConcrete = ... # type: QGradient.config
        StrongStick = ... # type: QGradient.config
        ViciousStance = ... # type: QGradient.config
        PaloAlto = ... # type: QGradient.config
        HappyMemories = ... # type: QGradient.config
        MidnightBloom = ... # type: QGradient.config
        Crystalline = ... # type: QGradient.config
        PartyBliss = ... # type: QGradient.config
        ConfidentCloud = ... # type: QGradient.config
        LeCocktail = ... # type: QGradient.config
        RiverCity = ... # type: QGradient.config
        FrozenBerry = ... # type: QGradient.config
        ChildCare = ... # type: QGradient.config
        FlyingLemon = ... # type: QGradient.config
        NewRetrowave = ... # type: QGradient.config
        HiddenJaguar = ... # type: QGradient.config
        AboveTheSky = ... # type: QGradient.config
        Nega = ... # type: QGradient.config
        DenseWater = ... # type: QGradient.config
        Seashore = ... # type: QGradient.config
        MarbleWall = ... # type: QGradient.config
        CheerfulCaramel = ... # type: QGradient.config
        NightSky = ... # type: QGradient.config
        MagicLake = ... # type: QGradient.config
        YoungGrass = ... # type: QGradient.config
        ColorfulPeach = ... # type: QGradient.config
        GentleCare = ... # type: QGradient.config
        PlumBath = ... # type: QGradient.config
        HappyUnicorn = ... # type: QGradient.config
        AfricanField = ... # type: QGradient.config
        SolidStone = ... # type: QGradient.config
        OrangeJuice = ... # type: QGradient.config
        GlassWater = ... # type: QGradient.config
        NorthMiracle = ... # type: QGradient.config
        FruitBlend = ... # type: QGradient.config
        MillenniumPine = ... # type: QGradient.config
        HighFlight = ... # type: QGradient.config
        MoleHall = ... # type: QGradient.config
        SpaceShift = ... # type: QGradient.config
        ForestInei = ... # type: QGradient.config
        RoyalGarden = ... # type: QGradient.config
        RichMetal = ... # type: QGradient.config
        JuicyCake = ... # type: QGradient.config
        SmartIndigo = ... # type: QGradient.config
        SandStrike = ... # type: QGradient.config
        NorseBeauty = ... # type: QGradient.config
        AquaGuidance = ... # type: QGradient.config
        SunVeggie = ... # type: QGradient.config
        SeaLord = ... # type: QGradient.config
        BlackSea = ... # type: QGradient.config
        GrassShampoo = ... # type: QGradient.config
        LandingAircraft = ... # type: QGradient.config
        WitchDance = ... # type: QGradient.config
        SleeplessNight = ... # type: QGradient.config
        AngelCare = ... # type: QGradient.config
        CrystalRiver = ... # type: QGradient.config
        SoftLipstick = ... # type: QGradient.config
        SaltMountain = ... # type: QGradient.config
        PerfectWhite = ... # type: QGradient.config
        FreshOasis = ... # type: QGradient.config
        StrictNovember = ... # type: QGradient.config
        MorningSalad = ... # type: QGradient.config
        DeepRelief = ... # type: QGradient.config
        SeaStrike = ... # type: QGradient.config
        NightCall = ... # type: QGradient.config
        SupremeSky = ... # type: QGradient.config
        LightBlue = ... # type: QGradient.config
        MindCrawl = ... # type: QGradient.config
        LilyMeadow = ... # type: QGradient.config
        SugarLollipop = ... # type: QGradient.config
        SweetDessert = ... # type: QGradient.config
        MagicRay = ... # type: QGradient.config
        TeenParty = ... # type: QGradient.config
        FrozenHeat = ... # type: QGradient.config
        GagarinView = ... # type: QGradient.config
        FabledSunset = ... # type: QGradient.config
        PerfectBlue = ... # type: QGradient.config
        Numconfigs = ... # type: QGradient.config
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, a0: 'QGradient.config') -> None: ...
    @typing.overload
...
class QPainter(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def fillRect(self, x: int, y: int, w: int, h: int, config: QGradient.config) -> None: ...
    @typing.overload
    def fillRect(self, r: QtCore.QRect, config: QGradient.config) -> None: ...
    @typing.overload
    def fillRect(self, r: QtCore.QRectF, config: QGradient.config) -> None: ...
    @typing.overload
