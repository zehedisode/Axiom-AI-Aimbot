...
%End
    void fillRect(int x, int y, int w, int h, QGradient::config config);
    void fillRect(const QRect &r, QGradient::config config);
    void fillRect(const QRectF &r, QGradient::config config);
