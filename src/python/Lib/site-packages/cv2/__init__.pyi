...
DISOpticalFlow_config_ULTRAFAST: int
DISOPTICAL_FLOW_config_ULTRAFAST: int
DISOpticalFlow_config_FAST: int
DISOPTICAL_FLOW_config_FAST: int
DISOpticalFlow_config_MEDIUM: int
DISOPTICAL_FLOW_config_MEDIUM: int
...
class DISOpticalFlow(DenseOpticalFlow):
    ...
    @classmethod
    def create(cls, config: int = ...) -> DISOpticalFlow: ...
